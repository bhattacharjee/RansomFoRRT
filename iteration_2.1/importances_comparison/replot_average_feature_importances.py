...
rename_map = {
    ...
    "advanced.moment_full.4": r"$4^{th}$ statistical moment",
    "advanced.moment_full.2": r"$2^{nd}$ statistical moment",
    "advanced.dit.tsallis.full.1": r"Tsallis' entropy $(n = 1)$",
    "advanced.dit.tsallis.full.0": r"Tsallis' entropy $(n = 0)$",
    "advanced.moment_full.6": r"$6^{th}$ statistical moment",
    ...
    "advanced.moment_full.8": r"$8^{th}$ statistical moment",
...
#"advanced.dit.renyi.full.1": r"Rényi's entropy $(\alpha = 1)$",
    ...
    "advanced.moment_full.12": r"$12^{th}$ statistical moment",
    ...
    "advanced.moment_full.5": r"$5^{th}$ statistical moment",
    "fourier.stat.1byte.moment.3": r"Fourier $3^{rd}$ moment (1 byte)",
    "advanced.dit.tsallis.full.3": r"Tsallis' entropy $(n = 3)$",
    "advanced.moment_full.7": r"$7^{th}$ statistical moment",
    "advanced.moment_full.9": r"$9^{th}$ statistical moment",
    "advanced.moment_full.11": r"$11^{th}$ statistical moment",
    "advanced.moment_full.13": r"$13^{th}$ statistical moment",
    "advanced.moment_full.15": r"$15^{th}$ statistical moment",
